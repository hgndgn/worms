...
std::vector<std::string> Random::getWormNames(std::string worm_name_file)
{
  std::ifstream file(worm_name_file);
...
Random::Random(std::string worm_name_file) :
  mersenne_twister_(getSeed()),
  worm_names_(getWormNames(worm_name_file))
{
}
