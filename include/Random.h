...
namespace se
{
  ...
  private:
    ...
    //
    static std::vector<std::string> getWormNames(std::string worm_name_file);

  public:
    //--------------------------------------------------------------------------
    // Constructs a new Random instance also loading the worm name file
    //
    Random(std::string worm_name_file);
